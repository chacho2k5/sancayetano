  ...
  <body style="font-size: 15px; font-family: Tahoma, Verdana, sans-serif;">
      ...
      <table style="width: 100%; border-collapse: collapse">
        ...
        <tr class="bbfino">
          ...
          <tr class="bbfino">
            ...
            <td class="brfino">Material: {{ $reg->material_nombre }}</td>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-top-width:0px">
        ...
        <tr style="border: 1px solid black; border-bottom: 0px;">
          <td colspan="12" style="height: 20px;padding-left: 4px; padding-top:13px; border-bottom: 1px solid rgb(177, 176, 176); ">Obs.:</td>
        </tr>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-top-width:0px;">
      ...
      <tr style="border: 1px solid black; border-bottom: 0px;">
        <td colspan="5" style="height: 20px;padding-left: 4px; padding-top:13px; border-bottom: 1px solid rgb(177, 176, 176); ">Obs.:</td>
      </tr>

      <tr style="border: 1px solid black; border-bottom: 0px;">
        <td colspan="2" style="height: 25px; padding-left: 4px; padding-top:10px">Inicio Impresión: ___/___/______</td>
        <td colspan="3" style="height: 25px; padding-top:10px; text-align: center">Fin Impresión: ___/___/______</td>
      </tr>

      <tr style="border: 1px solid black; border-bottom: 0px;">
        <td colspan="5" style="height: 20px;padding-left: 4px; padding-top:13px; border-bottom: 0px;">Tratado: 
          <span style="color: rgb(177, 176, 176);">_____________________________________________</span>
        </td>
      </tr>
      <tr style="border: 1px solid black; border-bottom: 0px; border-top: 0px;">
        <td colspan="5" style="height: 20px;padding-left: 4px; padding-top:13px; border-bottom: 0px">Cantidad Colores:
          <span style="color: rgb(177, 176, 176);">____________</span>
        </td>
      </tr>
      <tr style="border: 1px solid black; border-bottom: 0px;  border-top: 0px;">
        <td colspan="5" style="height: 20px;padding-left: 4px; padding-top:13px; border-bottom: 0px">Colores:
          <span style="color: rgb(177, 176, 176);">________________________________________________________________</span>
        </td>
      </tr>
      <tr style="border: 1px solid black; border-bottom: 0px;  border-top: 0px;">
        <td colspan="5" style="height: 10px;padding-left: 4px; padding-top:13px; border-bottom: 1px solid rgb(177, 176, 176); "></td>
      </tr>
    </table>
    {{-- CORTE --}}
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-top-width:0px">
      ...
      <tr style="border: 1px solid black; border-bottom: 0px; border-top: 0px;">
        <td colspan="6" style="height: 40px; padding-left: 4px; padding-top:10px;">Total Bolsas Cortadas: __________</td>
      </tr>
    </table>
  </div>
  </body>
