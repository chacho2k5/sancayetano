...
class TrabajoIndex extends Component
{
    ...
    public function calcularTotales() {
        $this->precio_subtotal = $this->precio_unitario * $this->cantidad_bolsas;
    ...
    public function updatedPrecioUnitario($value) {
        ...
        //     $this->precio_iva = $value + ($value * ($this->iva / 100));
        //     $this->precio_total = $this->precio_iva * $this->cantidad_bolsas;
        // } else {
