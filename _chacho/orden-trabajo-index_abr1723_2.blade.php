        ...
        <div class="card">
            ...
            <div class="my-table-responsive">
                {{-- <div class="table-scroll"> --}}
                    ...
                    {{-- <table class="table w-full table-hover table-bordered table-responsive my-table text-nowrap"> --}}
                        ...
                        <tbody class="my-body-table">
                            @foreach ( $registros as $reg)
                                <tr id={{ $reg->id }}
                                    ...
                                    x-on:click="selected !== {{ $reg->id }} ? selected = {{ $reg->id }} : selected = null, selectedRow = selected" 
                                    :class="{'bg-success text-black':selected === {{ $reg->id }} , 'bg-primary ':auxEstado == 4, 'bg-warning':auxReclamo }"
                                    >
