  ...
  <body style="font-size: 15px; font-family: Tahoma, Verdana, sans-serif;">
      ...
      <table style="width: 100%; border-collapse: collapse">
        ...
        <tr class="bbfino">
          ...
          <tr class="bbfino">
            ...
            <td class="brfino">Tratado: {{ $reg->tratado_nombre }}</td>
            <td class="brmedio"></td>
          </tr>
        @endforeach
      </table>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-top-width:0px">
        ...
        <tr style="border: 1px solid black; border-bottom: 0px;">
          <td colspan="7" style="height: 40px;padding-left: 4px; padding-top:13px">Máquina Nº: _________</td>
          <td colspan="5"style="height: 40px;padding-top:13px; text-align: center">Fecha Extrusión: ___/___/______</td>
        </tr>
        <tr>
        ...
        <tr style="border: 1px solid black; border-bottom: 0px;">
          <td colspan="12" style="height: 40px; padding-left: 4px; padding-top:10px;">Total Kgs Extrusora: __________</td>
        </tr>
    </table>
    {{-- IMPRESION --}}
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-top-width:0px">
      ...
      <tr style="border: 1px solid black; border-bottom: 0px;">
        <td colspan="2" style="height: 40px; padding-left: 4px; padding-top:13px">Nº Bobinas: _________</td>
        <td colspan="3" style="height: 40px; padding-top:13px; text-align: center">Fecha Impresión: ___/___/______</td>
      </tr>
      <tr>
        <td style="padding-left: 2px; width: 25px; border: 1px solid black">Nº</td>
        ...
        <td style="padding-left: 2px; width: 50px;"></td>
      </tr>
      <tr>
        <td style="text-align: right; padding-right: 2px; border: 1px solid black">1</td>
        <td style="border: 1px solid black"></td>
      ...
      <tr style="border: 1px solid black; border-bottom: 0px; border-top: 0px;">
        <td colspan="5" style="height: 40px; padding-left: 4px; padding-top:10px;">Total Kgs Extrusora: __________</td>
      </tr>
    </table>
    {{-- CORTE --}}
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-top-width:0px">
      ...
      <tr style="border: 1px solid black; border-bottom: 0px;">
        <td colspan="2" style="height: 40px; padding-left: 4px; padding-top:13px">Nº Bobinas: _________</td>
        <td colspan="3" style="height: 40px; padding-top:13px; text-align: center">Fecha Corte: ___/___/______</td>
      </tr>
      <tr>
        <td style="padding-left: 2px; width: 15%; border: 1px solid black">Operador</td>
        <td style="padding-left: 2px; width: 20%; border: 1px solid black"></td>
        <td style="padding-left: 2px; width: 20%; border: 1px solid black"></td>
        <td style="padding-left: 2px; width: 20%; border: 1px solid black"></td>
      ...
      <tr style="border: 1px solid black; border-bottom: 0px; border-top: 0px;">
        <td colspan="5" style="height: 40px; padding-left: 4px; padding-top:10px;">Total Bolsas Cortadas: __________</td>
      </tr>
    </table>
  </div>
  </body>
