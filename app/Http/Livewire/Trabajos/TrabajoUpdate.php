...
class TrabajoUpdate extends Component
{
    // Modales
    public $modal_title;
    public $modal_action;
    ...
    public $cantidad_bolsas, $metros, $peso, $observaciones;
    public $trabajo_activo = true;

    public $cantidad_bolsas_trabajo;
    public $precio_unitario;
    public $iva, $precio_iva;
    public $precio_total;
    ...
    public function mount($action, $id) {
        ...
        switch ($this->action) {
            case 'edit';
                $this->title = "Edición TRABAJO";
                $this->asignarCampos();
                break;
            case 'show';
                $this->title = "Datos TRABAJO";
                $this->asignarCampos();
                break;
            default:
                break;
    ...
    {
        return view('livewire.trabajos.trabajo-update');
    }
    ...
    public function asignarCampos() 
    {
        ...
        if ($reg->count() > 0) {
            ...
            $this->cantidad_bolsas_trabajo = $reg->cantidad_bolsas_trabajo;
