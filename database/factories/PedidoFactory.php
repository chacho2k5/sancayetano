...
class PedidoFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            // 'mes_id',
            // 'mes',
            'trabajo_nombre' => $this->faker->sentence(12,true),
            'ancho' => $this->faker->numberBetween(10,150),
            'largo' => $this->faker->numberBetween(30,220),
            'espesor' => $this->faker->numberBetween(10,80),
            'densidad_id' => $this->faker->numberBetween(1,2),
            'densidad_pesoespecifico' => $this->faker->randomElement(['1.84','1.92']),
            'material_id' => $this->faker->numberBetween(1,4),
            'color_id' => $this->faker->numberBetween(1,25),
            'color_id_1' => $this->faker->numberBetween(1,25),
            'color_id_2' => $this->faker->numberBetween(1,25),
            'color_id_3' => $this->faker->numberBetween(1,25),
            'color_id_4' => $this->faker->numberBetween(1,25),
            // 'color_nombre',
            ...
            // 'precio_unitario',
            // 'precio_total',
            'observaciones' => $this->faker->sentence(15,false),
