...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('trabajos', function (Blueprint $table) {
            ...
            $table->double('iva')->nullable()->default(0);         // Alicuota iva
            $table->double('precio_subtotal')->nullable()->default(0);  // Precio_unitario x Cantidad bolsas
            $table->double('importe_iva')->nullable()->default(0);         
            ...
            $table->string('observaciones_extrusion',2000)->nullable();
            $table->string('observaciones_impresion',2000)->nullable();
            $table->string('observaciones_corte',2000)->nullable();
