...
<div class="card-group mt-3">
        ...
        <div class="card-body">
            <h5 class="card-title">Pedidos ingresados en el mes:</h5>
            <p class="card-text"><h1>100</h1></p>
        </div>
        </div>
        ...
        <div class="card-header"></div>
        <div class="card-body">
            <h5 class="card-title">Pedidos con pendientes </h5>
            <p class="card-text"><h1>100</h1></p>
        </div>
        </div>
        ...
        <div class="card-header"></div>
        <div class="card-body">
            <h5 class="card-title">Pendidos en proceso </h5>
            <p class="card-text"><h1>100</h1></p>
        </div>
      </div>
...
<body>
    ...
    <div class="px-5 pt-5 my-5 container-fluid">
                ...
                <div class="shadow-sm card">
                    <div class="row">
                        <div class="pr-0 col-md-6">
                            <div class="p-3 card-body border-right border-bottom h-100">
                                <div class="flex-row pt-2 d-flex bd-highlight">
                                    <div>
                        ...
                        <div class="pl-0 col-md-6">
                            <div class="p-3 card-body border-bottom h-100">
                                <div class="flex-row pt-2 d-flex bd-highlight">
                                    <div>
                        ...
                        <div class="pr-0 col-md-6">
                            <div class="p-3 card-body border-right h-100">
                                <div class="flex-row pt-2 d-flex bd-highlight">
                                    <div>
